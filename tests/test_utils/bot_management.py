...
from kenbot_backtesting.errors import MissingTimeFrame
from kenbot_commons.logging.logging_util import get_logger
from kenbot_commons.tests.test_config import load_test_config

from kenbot.api.backtesting import create_independent_backtesting, \
...
async def create_bot() -> kenbot:
    return kenbot(load_test_config())
