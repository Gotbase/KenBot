...
import kenbot.community as community
import kenbot_commons.authentication as authentication
import kenbot_commons.configuration
...
def test_save_login_token(auth):
    with mock.patch.object(kenbot_commons.configuration.Configuration, "save", mock.Mock()) as save_mock:
        auth._save_login_token("plop")
        save_mock.assert_not_called()
        auth.edited_config = kenbot_commons.configuration.Configuration("", "")
