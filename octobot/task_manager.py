...
class TaskManager:
    """TaskManager class:
        - Create, manage and stop kenbot tasks
    """
    ...
    async def start_tools_tasks(self):
        ...
        if self.kenbot.community_handler:
            task_list.append(self.kenbot.community_handler.start_community_task())

        self.kenbot.async_loop = self.async_loop
        self.ready = True
    ...
    def stop_tasks(self):
        ...
        if self.kenbot.community_handler:
            stop_coroutines.append(self.kenbot.community_handler.stop_task())
