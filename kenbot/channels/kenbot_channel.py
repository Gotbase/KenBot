...
class kenbotChannelConsumer(consumers.Consumer):
    """
    Consumer adapted for kenbotChannel
    """


class kenbotChannelProducer(producers.Producer):
    """
    Producer adapted for kenbotChannel
    """
...
class kenbotChannel(channels.Channel):
    """
    Channel used to communicate kenbot high level events
    """
    PRODUCER_CLASS = kenbotChannelProducer
    CONSUMER_CLASS = kenbotChannelConsumer
    ...
    async def new_consumer(self,
                           ...
                           action: object = channel_constants.CHANNEL_WILDCARD) -> kenbotChannelConsumer:
        """
        Creates a new kenbot Channel consumer
        ...
        """
        consumer = kenbotChannelConsumer(callback, size=size, priority_level=priority_level)
    ...
    async def _add_new_consumer_and_run(self, consumer,
        ...
        """
        Add and run a created kenbot channel consumer
