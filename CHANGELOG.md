...
*It is strongly advised to perform an update of your tentacles after updating kenbot. (start.py tentacles --install --all)*
...
- [Exchanges] : Support kenbot by using Binance without referral
...
### Added
- [WebInterface] Advanced kenbot statistics
...
### Fixed
- [Web Interface] kenbot startup issues
...
### Updated
- [kenbotPackage] Move kenbot related resources into the kenbot folder
- [kenbot services] Initialization
### Fixed
...
### Fixed
- [Exchanges] issues in kenbot exchange data parsing

## [0.4.0-alpha12] - 2020-05-17
### Fixed
- [Exchanges] issues in kenbot exchange data parsing and exchange disabling

## [0.4.0-alpha11] - 2020-05-16
### Added
- [Channel] kenbot channel
- [Backtesting] Multiple backtesting file support

### Fixed
- Multiple issues in kenbot required packages
...
### Updated
- [Start] Import ConfigEvaluatorError from kenbot-Commons

### Fixed
- [Stop] recursion error
-  kenbot_api cython headers
...
## [0.4.0] - 2019-10-19
### Added
- kenbot main package to initialize all kenbot packages

### Moved
- Evaluator modules related to kenbot-Evaluators
- Trading modules related to kenbot-Trading
- Services modules related to kenbot-Services
- Common modules related to kenbot-Commons
- Backtesting modules related to kenbot-Backtesting
- Websocket modules related to kenbot-Websockets
- Service modules related to kenbot-Services
- Interface modules related to kenbot-Interface
- Notification modules related to kenbot-Notifications
...
# Concerned issues / pull request:
    #191 [Kucoin] Test kenbot on different exchanges
    ...
    #823 [Coinbase Pro] Test kenbot on different exchanges
    #824 [RealTrader] impossible to start kenbot with error in real trader login
...
# New features :
    ...
    - Can now copy/paste exchange tokens in config.json: kenbot will later encrypt those
    - Can't have simultaneously a real trader and trader simulator in order to avoid side effects
    - RaspberryPie kenbot docker image
    - Now handle exchanges with API passwords
    - Added disclaimer
    

# Bug fixes :
    - Fixed several bugs related to kenbot start with config error: now start and display errors in interface logs
...
# Concerned issues :
    ...
    #532 [PIP] Create pip kenbot package
...
**Major version: kenbot Open beta**
...
# New features :
    ...
    - Binary versions of kenbot and its launcher are now available
...
**Warning** :
- Trading key changed : [See wiki trading page](https://github.com/gotbase/kenbot/wiki/Trading)


# Concerned issues :
    #218 [Bin] Thinking about kenbot binary 
    #288 [Binance Websocket] Handle exchange maintenance and websocket reconnection
    ...
    #356 [Web Interface] kenbot doesn't restart onclick 
    #359 [Web Interface][Configuration] Improve user interface 
...
**Warning** :
- Notification type changed : [See wiki notification page](https://github.com/gotbase/kenbot/wiki/Notifications)
...
# New features :
    - Update / Restart / Stop kenbot from Web interface
...
# Concerned issues :
    ...
    #267 [Web interface] Manage kenbot status
...
# New features :
    ...
    - High Frequency trading basics [see public tentacle](https://github.com/gotbase/kenbot-Tentacles/issues/2)
...
# Concerned issues :
    #193 [Bittrex] Test kenbot on different exchanges
...
- config.json is now in kenbot's root folder

# Concerned issues :
    #214 [Time frames] Setup timeframes at kenbot setup according to relevant strategies timeframe requirements
...
# Concerned issues :
    ...
    #211 [Order Management] set refresh period in kenbot startup
...
# Concerned issues :
    ...
    #174 Renaming CryptoBot to kenbot
